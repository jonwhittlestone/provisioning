...
-------------------- | -------- | -------
code_server_ver      | (undefined) | code-server release name on [GitHub](https://github.com/coder/code-server/releases). <br> Defaults to the **latest** version (including pre-release).
